...
;
; Программа специально содержит superblock с искажённым magic
...
; =====================================================================
; emit_ztext(addr) — печатает NUL-терминированную строку в port 1.
; В негативном сценарии нам не нужны счётчики потока: достаточно
; простого побайтного OUT, чтобы валидатор увидел сообщение.
; =====================================================================
emit_ztext:
  STORE v_emit_addr
  ENTER 0
