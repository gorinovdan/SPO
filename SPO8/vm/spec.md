...
- INDEXB (base, index -> byte address)
- LOADB_IND
- STOREB_IND
...
- INDEXB/LOADB_IND/STOREB_IND are SPO8 additions for byte-level filesystem image parsing.
...
- SPO8 may set df_size to 0 through POP_SYS 19 to keep a shared runtime/image memory frame.
